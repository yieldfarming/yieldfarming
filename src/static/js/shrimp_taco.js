...
async function main() {
  ...
  const stakingTokenAddr = TACO_TOKEN_ADDR
  const stakingTokenTicker = 'TACO'
  const rewardPoolAddr = '0xF462399e89C004904E27C56ddb8cB31578798aCf'
  ...
  const prices = await lookUpPrices(['tacos', 'shrimp-finance'])
  const stakingTokenPrice = prices['tacos'].usd
