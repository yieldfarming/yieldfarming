...
async function main() {
    ...
    _print(`Claimable Rewards : ${toFixed(earnedYFI, 4)} YFII = ${toDollar(earnedYFI * YFIPrice)}`);
    _print(`Weekly estimate   : ${toFixed(rewardPerToken * stakedBPTAmount, 2)} YFII = ${toDollar(rewardPerToken * stakedBPTAmount * YFIPrice)} (out of total ${weekly_reward} YFII)`)
