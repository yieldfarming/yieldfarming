...
async function main() {
    ...
    _print(`Weekly estimate   : ${toFixed(rewardPerToken * stakedBPTAmount, 2)} YFFI = ${toDollar(rewardPerToken * stakedBPTAmount * YFFIPrice)} (out of total ${weekly_reward} YFFI)`)
